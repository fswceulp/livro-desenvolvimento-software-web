...
Para baixar outro projeto exemplo de manipulação de sessão, clique [aqui](https://github.com/jacksongomesbr/livro-web-codigo-fonte/tree/master/php/sessao/projeto2). 